...
//    }
//
//    // 매 5분 간격 40초마다 주간 정산 job 호출
//    @Scheduled(cron = "40 0,5,10,15,20,25,30,35,40,45,50,55 * * * *")
...
//    }
//
//    // 매 5분 간격 50초마다 월간 정산 job 호출
//    @Scheduled(cron = "50 0,5,10,15,20,25,30,35,40,45,50,55 * * * *")
